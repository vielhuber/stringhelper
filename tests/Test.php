...
class Test extends \PHPUnit\Framework\TestCase
{
    ...
    private $httpbin = 'https://hb.cran.dev';
    ...
    function test__x()
    {
        ...
        file_put_contents('tests/assets/empty_file.txt', 'foo');
        $this->assertTrue(__x(file_get_contents('tests/assets/empty_file.txt')));
...
'
    ...
    function test__remove_non_printable_chars()
    {
        ...
        $this->assertSame(__remove_non_printable_chars('foo�bar'), 'foobar');
        $this->assertSame(__remove_non_printable_chars('foo���bar'), 'foobar');
        $this->assertSame(__remove_non_printable_chars('Beleg 24,77 €  EUR äöüßÄÖÜ?`'), 'Beleg 24,77€ EUR äöüßÄÖÜ?`');
...
bar'
    ...
    function test__date()
    {
        ...
        $this->assertContains(__date('08 Jan 2025 13:48:55 UT', 'd.m.Y H:i:s'), [
            '08.01.2025 11:48:55',
            '08.01.2025 12:48:55',
            '08.01.2025 13:48:55',
            '08.01.2025 14:48:55',
...
Dies ist ein Test für falsche Umlaute.'
    ...
    function test__uuid()
    {
        ...
        $this->assertSame(__validate_uuid('00000000-0000-0000-0000-00000001aecd', false), true);
        $this->assertSame(__validate_uuid('00000000-0000-0000-0000-000000000000', false), true);
