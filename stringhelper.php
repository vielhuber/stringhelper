...
function __normalize_phone_number($value)
{
    if (__nx($value)) {
        return $value;
    }
    ...
    foreach (__get_phone_country_codes() as $phone_country_codes__value) {
        if (strpos($value, $phone_country_codes__value) === 0) {
            ...
            $country = $phone_country_codes__value;
    ...
    foreach (__get_area_codes() as $area_codes__value) {
        if (strpos($value, $area_codes__value) === 0) {
            $area = $area_codes__value;
