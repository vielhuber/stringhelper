...
|                                 | <sub>\_\_x($)</sub> | <sub>\_\_true($)</sub> | <sub>\_\_false($)</sub> | <sub>$ !== null</sub> | <sub>$ != null</sub> | <sub>$ !== false</sub> | <sub>$ != false</sub> | <sub>$ === true</sub> | <sub>$ == true</sub> | <sub>!is_null($)</sub> | <sub>isset($)</sub> | <sub>!empty($)</sub> | <sub>if($)</sub>   | <sub>if(!$)</sub>  | <sub>($)?true:false</sub> | <sub>if($??'')</sub> | <sub>if(($??'') !== '')</sub> | <sub>if(($??'') != '')</sub> | <sub>count($) > 0</sub> | <sub>$ != ''</sub> | <sub>$ !== ''</sub> |
| ------------------------------- | ------------------- | ---------------------- | ----------------------- | --------------------- | -------------------- | ---------------------- | --------------------- | --------------------- | -------------------- | ---------------------- | ------------------- | -------------------- | ------------------ | ------------------ | ------------------------- | -------------------- | ----------------------------- | ---------------------------- | ----------------------- | ------------------ | ------------------- |
